...
def create_presigned_post(bucket_name, object_name,
    ...
    # s3_client = boto3.client('s3', AWS_UPLOAD_ACCESS_KEY_ID)
...
def main():
    ...
    object_name = 'upload_test/${filename}'
    ...
    with open('post_url.txt', 'rb') as f:
        files = {'file': ('post_url.txt', f)}
        logging.info("POSTing to URL: {}".format(response['url']))
